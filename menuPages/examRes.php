        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="font-weight-bold text-dark text-center">Exam Result</h4>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <div class="input-group-append">
                              <button class="btn btn-sm btn-warning" type="button"><a href="examRes.php" class="text-light">Reset</a></button>
                            </div>
                          </div>
                        </div>
                      </div>
