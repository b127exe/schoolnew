...
<body>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="font-weight-bold text-dark">Add Teacher</h4>
                  ...
                  <form class="forms-sample" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputFirst1" name="fname">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputLast1">Last Name</label>
                      <input type="text" class="form-control" id="exampleInputLast1" name="lname">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputDob1">Date of birth</label>
                      <input type="text" class="form-control" id="exampleInputDob1" name="dob">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputContact1" name="phone">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEducation1">Education</label>
                      <input type="text" class="form-control" id="exampleInputEducation1" name="education">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="insertTea">Submit</button>
                  </form>
                </div>
              </div>
            </div>
  ...
  if(isset($_POST['insertTea'])){
   ...
   $sql1 = "INSERT INTO teacher(t_fname,t_lname,t_address,phone,dob,education,gender,email) VALUES('$fname','$lname','$address','$phone','$dob','$education','$gender','$email')";

   $res1 = mysqli_query($conn,$sql1) or die('Not Insert');

   if($res1)
   {
     echo "
     <script>window.location.href = 'http://localhost/schoolnew/accountant.php'</script>
     ";
   }
