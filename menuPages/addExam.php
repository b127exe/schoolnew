...
$sql = "SELECT * FROM student AS s INNER JOIN class AS c ON s.cid = c.cid INNER JOIN subject AS su ON s.subid = su.subid WHERE sid = $esid";
...
<body>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="font-weight-bold text-dark">Add Exam</h4>
                                    ...
                                    <form class="forms-sample" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputDob1">Exam Date</label>
                                            <input type="text" class="form-control" id="exampleInputDob1" name="eDate" placeholder="yyyy-mm-dd">
                                        </div>
                                        <div class="form-group">
    ...
    if (isset($_POST['insertExam'])) {
        ...
        $sql1 = "INSERT INTO exam(sid,exam_date,e_time) VALUES($esid,'$Edate','$Etime')";
