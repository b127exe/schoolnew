...
if (isset($_GET['searchBtn'])) {
  ...
  $sql = "SELECT * FROM parent WHERE $list LIKE '%$search%'";
}
else{
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <select class="form-control" style="padding: 14px;" required name="list">
                        <option value="pid">Parent Id</option>
          ...
          <div class="col-md-5 mx-auto scrollbar" style="height: 280px; overflow: hidden;overflow-y: scroll;">
              ...
              if(mysqli_num_rows($res) > 0 ){
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    <p class='text-white'>parent$row[pid]</p>
                     <h2 class='font-weight-bold text-white'>$row[name]</h2>
                     <p class='text-white'>$row[email]</p>
                     <strong style='display: block;color: #fff;'>$row[job]</strong>
                     <a href='parent.php?pid=$row[pid]' class='btn btn-primary btn-lg btn-block mt-3'>
