...
$sql = "SELECT * FROM exam AS e INNER JOIN student AS s ON e.sid = s.sid INNER JOIN parent AS p ON s.pid = p.pid INNER JOIN class AS c ON s.cid = c.cid INNER JOIN subject AS su ON s.subid = su.subid INNER JOIN section AS sec ON c.section = sec.sec_id WHERE e.sid = $sid";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <h4 class="font-weight-bold text-dark">Your Schedule</h4>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
