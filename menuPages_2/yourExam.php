...
$sql = "SELECT * FROM exam_result AS es INNER JOIN exam AS e ON es.eid = e.eid INNER JOIN student AS s ON e.sid = s.sid INNER JOIN parent AS p ON s.pid = p.pid INNER JOIN class AS c ON s.cid = c.cid INNER JOIN section AS sec ON c.section = sec.sec_id INNER JOIN subject AS su ON s.subid = su.subid WHERE s.sid = $sid";
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-exam">
              <ul class="nav flex-column sub-menu">
                ...
                <li class='nav-item'> <a class='nav-link' href='yourExam.php?sid=$sid'>Exam Result</a></li>";
                ?>               
              </ul>
            </div>
          </li>
      ...
      <div class="main-panel">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <h4 class="font-weight-bold text-dark">Your Result</h4>
            </div>
          </div>   
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
